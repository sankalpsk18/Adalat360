  ...
  head: () => ({
    meta: [
      ...
      { title: "ADALAT360 — Secure Digital Evidence & Records" },
      {
        name: "description",
        content:
          "Role-based digital document and evidence management prototype with hash-chained custody, versioning and conflict-aware search.",
      },
      { name: "author", content: "ADALAT360" },
      { property: "og:title", content: "ADALAT360 — Secure Digital Evidence & Records" },
      {
